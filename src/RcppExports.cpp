...
// simulate_GRN
int simulate_GRN(IntegerMatrix gene_interaction, NumericVector threshold_gene, double g_min, double g_max, double k_min, double k_max, int possible_interactions, long model_count_max, long threshold_max, double h, double lambda_min, double lambda_max, int n_min, int n_max, double tot_time, double median_range, double standard_deviation_factor, int number_gene, double D_max, double D_shot_scaling, int GENE_NOISE_SCALING, int file_writing_interval, int D_levels, double D_scaling, int output_precision, int ANNEALING, int CONSTANT_NOISE, int INITIAL_CONDITIONS, String filename, bool parameters_file, bool readIC);
RcppExport SEXP _sRACIPEv03_simulate_GRN(SEXP gene_interactionSEXP, SEXP threshold_geneSEXP, SEXP g_minSEXP, SEXP g_maxSEXP, SEXP k_minSEXP, SEXP k_maxSEXP, SEXP possible_interactionsSEXP, SEXP model_count_maxSEXP, SEXP threshold_maxSEXP, SEXP hSEXP, SEXP lambda_minSEXP, SEXP lambda_maxSEXP, SEXP n_minSEXP, SEXP n_maxSEXP, SEXP tot_timeSEXP, SEXP median_rangeSEXP, SEXP standard_deviation_factorSEXP, SEXP number_geneSEXP, SEXP D_maxSEXP, SEXP D_shot_scalingSEXP, SEXP GENE_NOISE_SCALINGSEXP, SEXP file_writing_intervalSEXP, SEXP D_levelsSEXP, SEXP D_scalingSEXP, SEXP output_precisionSEXP, SEXP ANNEALINGSEXP, SEXP CONSTANT_NOISESEXP, SEXP INITIAL_CONDITIONSSEXP, SEXP filenameSEXP, SEXP parameters_fileSEXP, SEXP readICSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerMatrix >::type gene_interaction(gene_interactionSEXP);
...
// multiGeneCircuit_RK_deterministic_thMod
int multiGeneCircuit_RK_deterministic_thMod(IntegerMatrix gene_interaction, NumericVector threshold_gene, double g_min, double g_max, double k_min, double k_max, int possible_interactions, long model_count_max, long threshold_max, double h, double lambda_min, double lambda_max, int n_min, int n_max, double tot_time, double median_range, double standard_deviation_factor, int number_gene, int output_precision, int INITIAL_CONDITIONS, String filename);
RcppExport SEXP _sRACIPEv03_multiGeneCircuit_RK_deterministic_thMod(SEXP gene_interactionSEXP, SEXP threshold_geneSEXP, SEXP g_minSEXP, SEXP g_maxSEXP, SEXP k_minSEXP, SEXP k_maxSEXP, SEXP possible_interactionsSEXP, SEXP model_count_maxSEXP, SEXP threshold_maxSEXP, SEXP hSEXP, SEXP lambda_minSEXP, SEXP lambda_maxSEXP, SEXP n_minSEXP, SEXP n_maxSEXP, SEXP tot_timeSEXP, SEXP median_rangeSEXP, SEXP standard_deviation_factorSEXP, SEXP number_geneSEXP, SEXP output_precisionSEXP, SEXP INITIAL_CONDITIONSSEXP, SEXP filenameSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerMatrix >::type gene_interaction(gene_interactionSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type INITIAL_CONDITIONS(INITIAL_CONDITIONSSEXP);
    Rcpp::traits::input_parameter< String >::type filename(filenameSEXP);
    rcpp_result_gen = Rcpp::wrap(multiGeneCircuit_RK_deterministic_thMod(gene_interaction, threshold_gene, g_min, g_max, k_min, k_max, possible_interactions, model_count_max, threshold_max, h, lambda_min, lambda_max, n_min, n_max, tot_time, median_range, standard_deviation_factor, number_gene, output_precision, INITIAL_CONDITIONS, filename));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sRACIPEv03_simulate_GRN", (DL_FUNC) &_sRACIPEv03_simulate_GRN, 31},
    ...
    {"_sRACIPEv03_multiGeneCircuit_RK_deterministic_thMod", (DL_FUNC) &_sRACIPEv03_multiGeneCircuit_RK_deterministic_thMod, 21},
