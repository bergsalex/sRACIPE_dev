...
int multiGeneCircuit_RK_deterministic_knockout(IntegerMatrix gene_interaction, NumericVector threshold_gene,
                                      ...
                                      int output_precision, int INITIAL_CONDITIONS, String filename, int knockout = NA_INTEGER)

{
  std::string file_name= filename;
    ...
    for(long model_count=0;model_count<model_count_max;model_count++)
    {
        ...
        //std::cout<<knockout<<"\n";
      //  if(knockout !=NumericVector::is_na(knockout) )  //doesn't work when knockout==0
          { //std::cout<<"Here"<<"\n";
          g_gene[knockout]=0.0;
          //std::cout<<g_gene[knockout]<<"\n";
          }
        ...
        for(int ic_count=0;ic_count<INITIAL_CONDITIONS;ic_count++)
        {
          ...
          //  if(knockout !=NumericVector::is_na(knockout) )
            { //std::cout<<"Here"<<"\n";
        //if(expression_gene0[knockout]< 0)
              expression_gene0[knockout]=0.0;
              //std::cout<<g_gene[knockout]<<"\n";
            }
            ///////////////////////////////////////////////////////////////////////////////////////
